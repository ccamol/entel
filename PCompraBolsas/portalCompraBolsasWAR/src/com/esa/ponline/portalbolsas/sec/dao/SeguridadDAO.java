...
//import com.esa.ponline.portalbolsas.ws.locator.WebServiceLocator;
//import com.esa.ponline.portalbolsas.ws.locator.WebServiceLocatorException;
...
public class SeguridadDAO implements Serializable {
    ...
    public static final String CODIGO_RESPUESTA_OK = LoadProperty.getProperty("servicios.codigoRespuesta.exito");
...
//    }
         ...
         */
        private ERPGestionDeSeguridadServicePortType getERPGestionDeSeguridadServiceConnection() {
            ...
            try {
                ...
                LOGGER.error("Error al inicializar el Port " + ERPGestionDeSeguridadServicePortType.class, e);
                LOGGER.error("Tiempo: " + watch.time() + " | " + ERPGestionDeSeguridadServicePortType.class);
                e.printStackTrace();
            } catch (Exception e) {
                LOGGER.error("Error al inicializar el Port " + ERPGestionDeSeguridadServicePortType.class, e);
                LOGGER.error("Tiempo: " + watch.time() + " | " + ERPGestionDeSeguridadServicePortType.class);
    ...
    public String consultarIDPAmpliacion(String numeroPcs) throws DAOException,
        ...
        ERPGestionDeSeguridadServicePortType port = null;
        LOGGER.info("Instanciando el port " + ERPGestionDeSeguridadServicePortType.class);
...
//            LOGGER.error( new DAOException(e));
//        }
        port = getERPGestionDeSeguridadServiceConnection();
        ...
        try {
            ...
            LOGGER.error("Exception caught on Service invocation: consultarIdp", e);
            LOGGER.error( new DAOException(e));
        }
        ...
        if (PCBUtils.isEmptyString(codigoRespuesta)) {
            LOGGER.error( new DAOException("consultarIdp: Servicio no respondio " + "con codigoRespuesta"));
        }

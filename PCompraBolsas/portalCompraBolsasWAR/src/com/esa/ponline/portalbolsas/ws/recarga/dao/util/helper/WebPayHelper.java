...
import com.esa.ponline.portalbolsas.bean.ParametrosWebPay;
...
public class WebPayHelper {
    ...
    public static String generarCodigoUnicoTransaccion() {
        ...
        LOGGER.info("Generando codigo unico transaccion");
        
        for (@SuppressWarnings("unused")
        int i = 0; total.length() < 4; ++i) {
    ...
    //TODO This main is for test webPay parameters

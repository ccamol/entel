 ...
 *         EntelPcs) 
 */
public final class EPCSEncriptedAuthenticationImpl implements
     ...
     */
    private static final Logger logger = Logger.getLogger(EPCSEncriptedAuthenticationImpl.class);
	...
	public void initialize(final ProviderMBean mbean,
		...
		EPCSEncriptedAuthenticationProviderMBean myMBean = (EPCSEncriptedAuthenticationProviderMBean) mbean;
    ...
    public AppConfigurationEntry getLoginModuleConfiguration() {
        logger.info(EPCSEncriptedLoginModuleImpl.class);
		
        return new AppConfigurationEntry(EPCSEncriptedLoginModuleImpl.class

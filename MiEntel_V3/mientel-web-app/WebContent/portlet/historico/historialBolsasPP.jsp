...
var pagTotal;
	...
	<div class="linea_tabs clearfix">
				...
				<div class="tab contenido1" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Telefonia/Historicos/Recargas');">
				...
				<div class="tab contenido2" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Telefonia/Historicos/Bolsas Compradas');">
    ...
    <p>Se presentan a continuación las bolsas compradas en los <strong>últimos 6 meses a contar del día 23 de mayo de 2013.</strong></p>
	<h1>
							...
							<h:panelGroup rendered="#{!traficoEnLineaController.errorDetalleTraficoEnLineaPPCC}">
								<div class="header_tabla trafico clearfix">
									...
									<div class="main">
										...
										<table>
											<tr class="titulos">
												...
												<th width="68px">Fecha y Hora envío de SMS</th>
									...
									<div class="contenido_tabla">
											<h:panelGroup rendered="#{ !historialBolsasController.registros }">
											    <p>&nbsp;</p>
											 	<p align="center">No registras compra de bolsas en los últimos 6 meses.</p>
											</h:panelGroup>

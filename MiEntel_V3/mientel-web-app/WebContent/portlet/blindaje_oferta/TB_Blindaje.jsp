...
<f:view beforePhase="#{ofertaBlindajeController.initBlindaje}" > 
...
function marcaSmartPixel(){	
	var url='<%=request.getContextPath()%>/portlet/blindaje_oferta/TB_BlindajeJson.faces';
	   ...
	   if ($.browser.msie && parseInt($.browser.version) == 8) {
	    ...
	    $("td.lb_bb").css( {
		  ...
		  if ($.browser.msie && parseInt($.browser.version) == 7) {
			  ...
			  if(grupoOfertaBlindaje.indexOf("G8")>=0 || grupoOfertaBlindaje.indexOf("G10")>=0){
				  $("#TB_closeWindowButton").css( {
	    ...
	    if (codOfertaBlindaje != 0){
	    	...
	    	if(grupoOfertaBlindaje.indexOf("G7")>=0){
				  ...
				  if ($.browser.msie && parseInt($.browser.version) == 7) {
					  $("#TB_closeAjaxWindow").append("<br/><a id='TB_closeRejectWindowButton' href='#' onClick='_gaq.push(['_trackEvent', 'FE_Sumate_2012_v1', 'lightbox', 'no_mostrar']);'></a>");
			...
			}else if(grupoOfertaBlindaje.indexOf("G8")>=0 || grupoOfertaBlindaje.indexOf("G10")>=0){

				if ($.browser.msie && parseInt($.browser.version) == 7) {
					  $("#TB_closeAjaxWindow").append("<br/><a id='TB_closeRejectWindowButton' href='#'></a>");
					  $("#TB_closeRejectWindowButton").css( {
					        padding : "5px 164px 146px 38px",
					        position : "relative",
					        background:"transparent",
					        top: "-115px",
					        left:"-152px",
		...
		<div class="TB_ajaxContent2" allowtransparency="true" >		    	        
				<iframe id="frame_blindaje" allowtransparency="true" src="<h:outputText value="#{ofertaBlindajeController.urlCargarOferta}" />"  frameBorder=0 width="701"  height="1315"></iframe>
		</div>

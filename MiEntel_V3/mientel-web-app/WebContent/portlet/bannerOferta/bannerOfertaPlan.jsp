...
function consultarOfertaBannerPlanBlindaje(){		
...
function levantarOfertaBannerPlanBlindaje(){		
	...
	$(document).ready(function() {
		$("a.enlaceOferta").fancybox({		
		  ...
		  consultarOfertaBannerPlanBlindaje();				
	});
</script>
</head>
<body>
	<div id="bannerOfertaBlindajeG4" class="clearfix" style="width: 600px; padding-bottom: 15px;padding-top: 6px;display: none;">
		<div style="width:95%;margin-top: -20px;line-height:1.80em;z-index: 3;position: relative;  ">
			<a href="javascript:levantarOfertaBannerPlanBlindaje();">
				<img src="${pageContext.request.contextPath}/portlet/bannerOferta/img/bannersumate_plan.png"/>
			</a>
		</div>
 	</div>

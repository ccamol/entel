			...
			<div class="pago_automatico_bloque">
				...
				<div class="caja verde clearfix">
					...
					<div class="caja_texto_pac">
						<p>La inscripci&oacute;n de Pago Autom&aacute;tico la debes realizar en tu <a href="#" title="Pronto Podrás Consultar las Sucursales" class="autoTooltip titleTT link_pago"><u>sucursal</u></a> Entel PCS.<br /></p>

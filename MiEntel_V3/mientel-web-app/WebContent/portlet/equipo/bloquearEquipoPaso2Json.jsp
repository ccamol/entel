...
<f:view beforePhase="#{bloqueoDesbloqueoEquipoController.consultarHistoricoEquipos}">
	
	<h:panelGroup rendered="#{bloqueoDesbloqueoEquipoController.renderedListaTraficoEquipos}">
		<it:iterator var="item" value="#{bloqueoDesbloqueoEquipoController.listaTraficoEquipos}" rowIndexVar="row">
	                	<div class="lista">

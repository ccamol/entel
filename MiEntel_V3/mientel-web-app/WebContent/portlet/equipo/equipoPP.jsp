...
<cm:search id="loadingCR" query="idContenido = 'loadingContactoRenovacion'" useCache="true"  />
<cm:search id="loadingPP" query="idContenido = 'loadingPeticionPresupuesto'" useCache="true"  />
<cm:search id="loadingBE" query="idContenido = 'loadingBloqueoEquipo'" useCache="true"  />
...
function contactoRenovacion(){
	...
	$('#msg').show();
	$('#contactoBox').html('<p><strong>Enviando peticion de presupuesto</strong><br /><img src="../framework/skins/mientel/img/thickbox/TB_cargando.gif"></img></p>');
...
function volverOT(pres){	
	...
	<div class="linea_tabs clearfix">
				<div class="tab contenido1" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Telefonia/Equipo/Bloquear');">

					<span class="bloquear">
						Bloquear
					</span>
				</div>
				<div class="tab contenido2" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Telefonia/Equipo/Servicio tecnico');">
					<span class="servicio_tecnico">
						Servicio t&eacute;cnico
					</span>
				</div>

				<div class="tab contenido3" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Telefonia/Equipo/Liberacion');">
				...
				<div class="contenido_tab altEquipo contenido2">
					...
					<div id="tablas_presupuesto" style="position:relative">
						<h2 class="sin_icono">Ordenes de trabajo vigentes</h2>
							...
							<a class="boton_parrafo servicioTecnicoEnlace" title="PreIngreso Servicio T&eacute;cnico"
								href="<r:pageUrl pageLabel='${pagePreingresoOt}'></r:pageUrl>">
								<span>Solicitar Servicio T&eacute;cnico</span>
							</a>				
							<!-- nuevo enlace PreIngresoOT -->

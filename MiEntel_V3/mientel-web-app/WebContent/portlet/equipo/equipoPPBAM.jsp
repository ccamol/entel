...
<cm:search id="confSMSEquipo" query="idContenido = 'configuracionSMSEquipo'" useCache="true"  />
<cm:search id="confMMSEquipo" query="idContenido = 'configuracionMMSEquipo'" useCache="true"  />
<cm:search id="confIMEquipo" query="idContenido = 'configuracionIMEquipo'" useCache="true"  />
<cm:search id="confWAPEquipo" query="idContenido = 'configuracionWAPEquipo'" useCache="true"  />
<cm:search id="confMailEquipo" query="idContenido = 'configuracionMailEquipo'" useCache="true"  />
...
<cm:search id="estadoEquipoServicioTecnico" query="idContenido = 'estadoEquipoServicioTecnico'" useCache="true"  />
...
function bloquearEquipo(){
	...
	$.ajax({
		...
		area: "<h:outputText value="#{equipoBAMController.datosUsuarioBloqueo.areaTelefono}" />",
		telefono: "<h:outputText value="#{equipoBAMController.datosUsuarioBloqueo.telefono}" />" 
		},
...
$(document).ready(function(){
	...
	var param2 = obtenerParametroURL("contexto");  
	if (param2 == 'servicioTecnico') {
...
function obtenerParametroURL(name) {		 
	...
	<div class="linea_tabs clearfix">
				<div class="tab contenido1" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Banda Ancha Movil/Equipo/Servicio tecnico');">
					<span class="servicio_tecnico">
						Servicio t&eacute;cnico
					</span>
				</div>

				<div class="tab contenido3" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Banda Ancha Movil/Equipo/Configuracion');">
                        ...
                        <div class="escoge-movil clearfix">
                            ...
                            <div class="fieldset">
                                ...
                                <div class="fila-campo clearfix">
                                    ...
                                    <div class="campo"><a class="btnBloqueoBAMPaso2 btnDesactivado" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Telefonia/Equipo/Bloquear/Confirmar');"><span>Continuar</span></a></div>
					...
					<div id="bloqueo_3" class="bloqueo">
                        ...
                        <div class="fieldset" style="height: 50px;">
                            ...
                            <div class="fila-campo clearfix">
                                ...
                                <div class="campo"><a class="btnBloqueoBAMPaso3 btnDesactivado" onclick="mxTracker._trackPageview('Personas/Mi Entel/Mis Productos/Telefonia/Equipo/Bloquear/Bloqueado');"><span>Bloquear</span></a></div>
		...
		<!-- FIN BLOQUEO - DESBLOQUEO EQUIPOS  -->				
				...
				<div class="contenido_tab altEquipo contenido3">
					...
					<div class="formulario_configuracion">						
						<cm:getProperty node="${confSMSEquipo[0]}" name="html" />
						<cm:getProperty node="${confMMSEquipo[0]}" name="html" />
						<cm:getProperty node="${confIMEquipo[0]}" name="html" />
						<cm:getProperty node="${confWAPEquipo[0]}" name="html" />
						<cm:getProperty node="${confMailEquipo[0]}" name="html" />											
					</div>

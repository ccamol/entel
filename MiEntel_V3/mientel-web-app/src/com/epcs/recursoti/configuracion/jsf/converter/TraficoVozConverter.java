 ...
 * 
 */
public class TraficoVozConverter implements Converter {
    ...
    public String getAsString(FacesContext context, UIComponent component,
        ...
        //DecimalFormatSymbols dfs = new DecimalFormatSymbols(new Locale("es_CL"));
        ...
        double minutos = Math.floor(trafico);
        double segundos = (trafico - minutos) * 60;

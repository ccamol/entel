...
public class ChartFacturacionImageServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	      ...
	      try{
			  ...
			  rut = ProfileWrapperHelper.getPropertyAsString(profileWrapper,
			          "rutTitular");
			  numeroCuenta = ProfileWrapperHelper.getPropertyAsString(
		     ...
		     int intervalosGrafica = Integer.parseInt(resumenFacturacionBean.getNumIntervalosGrafico());
		     
		      try{
		        
		        int numIntervalos = resumenFacturacionBean.getFacturacionMeses().size() < intervalosGrafica ? resumenFacturacionBean.getFacturacionMeses().size() : intervalosGrafica;   
	            ...
	            for (int i=0; i < numIntervalos ; i++){
		    	  ...
		    	  LOGGER.error("Exception al intentar configurar y armar los valores de la grafica msisdn = "+numeroPcs +"- rut:"+rut + "- cuenta:"+numeroCuenta, e);
		      }

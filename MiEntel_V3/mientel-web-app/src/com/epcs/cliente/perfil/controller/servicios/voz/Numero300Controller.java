...
public class Numero300Controller implements Serializable {
    ...
    /**
     * Logger para Numero300Controller
     */
    private static final Logger LOGGER = Logger
            .getLogger(Numero300Controller.class);

    public Numero300Controller() {
    }

    /**
     * Action method para activar numero 300
     * 
     * @return null
     */
    public String activarNum300() {
        ...
        try {
            ...
            JSFMessagesHelper.addServiceSuccessMessage("adminServicios",
                    "activacionNum300", new String[] { resultado
                            .getNumeroPcs() });

        } catch (DAOException e) {
            LOGGER.error("DAOException caught al activar servicio", e);
            JSFMessagesHelper.addErrorMessage("adminServicios", "activacionNum300");
     ...
     * @return null
     */
    public String desactivarNum300() {
        ...
        try {
            ...
            // mensaje exito
            JSFMessagesHelper.addServiceSuccessMessage("adminServicios",
                    "desactivacionNum300", new String[] { resultado
                            .getNumeroPcs() });

        } catch (DAOException e) {
            LOGGER.error("DAOException caught", e);
            JSFMessagesHelper.addErrorMessage("adminServicios", "desactivacionNum300");
        } catch (ServiceException e) {
            LOGGER.info("ServiceException caught");
            JSFMessagesHelper.addErrorCodeMessage("adminServicios", e
                    .getCodigoRespuesta());
    ...
    private ResultadoServicioBean activacion(String numeroPcsSeleccionado)
        ...
        return delegate.activarNumero300(numeroPcsSeleccionado);
    }

    private ResultadoServicioBean desactivacion(String numeroPcsSeleccionado)
            throws DAOException, ServiceException {
        AdministracionServiciosDelegate delegate = new AdministracionServiciosDelegate();
        return delegate.desactivarNumero300(numeroPcsSeleccionado);
    }

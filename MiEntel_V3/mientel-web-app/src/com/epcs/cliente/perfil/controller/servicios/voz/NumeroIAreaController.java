...
public class NumeroIAreaController implements Serializable {
    ...
    /**
     * Logger para NumeroIAreaController
     */
    private static final Logger LOGGER = Logger
            .getLogger(NumeroIAreaController.class);

    public NumeroIAreaController() {
    }

    /**
     * Action method para activar numero interarea
     * 
     * @return null
     */
    public String activarIArea() {
        ...
        try {
            ...
            JSFMessagesHelper.addServiceSuccessMessage("adminServicios",
                    "activacionIArea", new String[] { resultado
                            .getNumeroPcs() });

        } catch (DAOException e) {
            LOGGER.error("DAOException caught al activar servicio", e);
            JSFMessagesHelper.addErrorMessage("adminServicios", "activacionIArea");
    ...
    public String desactivarIArea() {
        ...
        try {
            ...
            // mensaje exito
            JSFMessagesHelper.addServiceSuccessMessage("adminServicios",
                    "desactivacionIArea", new String[] { resultado
                            .getNumeroPcs() });

        } catch (DAOException e) {
            LOGGER.error("DAOException caught", e);
            JSFMessagesHelper.addErrorMessage("adminServicios", "desactivacionIArea");
        } catch (ServiceException e) {
            LOGGER.info("ServiceException caught");
            JSFMessagesHelper.addErrorCodeMessage("adminServicios", e
                    .getCodigoRespuesta());
    ...
    private ResultadoServicioBean activacion(String numeroPcsSeleccionado)
        ...
        return delegate.activarNumeroInterarea(numeroPcsSeleccionado);
    }

    private ResultadoServicioBean desactivacion(String numeroPcsSeleccionado)
            throws DAOException, ServiceException {
        AdministracionServiciosDelegate delegate = new AdministracionServiciosDelegate();
        return delegate.desactivarNumeroInterarea(numeroPcsSeleccionado);
    }

 ...
 * 
 */
public class MigracionPrepagoPlanHandler extends AbstractMensajeHandler {
	
	/**
     * Logger para BienvenidaHandler
     */
    private static final Logger LOGGER = Logger
            .getLogger(MigracionPrepagoPlanHandler.class);

    @Override
    public String getMensajeId() {
        return MiEntelProperties
                .getProperty("mensajesParaTi.servicios.migracionPrepagoPlan.id");
    }
    ...
    protected MensajeParaTiBean resolverMensaje(Node nodeMensajes,
        ...
        String mensajeBad = MensajesParaTiHelper
                .obtenerMensajeTipoBad("migracionPrepagoPlan");

        try {
        	String txtMensaje = "";
            String idContenido = MensajesParaTiHelper.getMensMigracionPrepagoPlan();

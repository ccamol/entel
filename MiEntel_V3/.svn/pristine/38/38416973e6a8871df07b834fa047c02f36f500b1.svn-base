<jsp:root
	...
	<skeleton:context type="flowlayoutpc">
		<skeleton:control name="div" presentationContext="${flowlayoutpc}" presentationId="contenido" presentationClass="clearfix">
			...
			<c:set var="center"   value="${ph[1]}"/>
			<c:set var="right" value="${ph[2]}"/>
		    ...
		    <skeleton:control name="div" presentationContext="${flowlayoutpc}" presentationId="centro" presentationClass="contenedor_central">
			    <skeleton:child presentationContext="${center}"/>	
		    </skeleton:control> 

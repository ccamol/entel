<jsp:root
	...
	<skeleton:context type="flowlayoutpc">
		<skeleton:control name="div" presentationContext="${flowlayoutpc}" presentationId="contenido" presentationClass="clearfix">
			...
			<c:set var="center1"   value="${ph[1]}"/>
			<c:set var="center2"   value="${ph[2]}"/>
			<c:set var="center3"   value="${ph[3]}"/>
			<c:set var="center4"   value="${ph[4]}"/>
		    ...
		    <skeleton:control name="div" presentationContext="${flowlayoutpc}" presentationId="centro" presentationClass="db-centro">
		    	<skeleton:control name="div" presentationContext="${flowlayoutpc}" presentationClass="db-bloque-tablas primer-ph clearfix">
			    	<skeleton:child presentationContext="${center1}"/>
			    </skeleton:control>
			    <skeleton:control name="div" presentationContext="${flowlayoutpc}" presentationClass="db-bloque-tablas clearfix">
			    ...
			    <skeleton:control name="div" presentationContext="${flowlayoutpc}" presentationClass="db-bloque-tablas dash-pp bottom-side clearfix">
			    	<skeleton:child presentationContext="${center4}"/>
			    </skeleton:control>
		    </skeleton:control>

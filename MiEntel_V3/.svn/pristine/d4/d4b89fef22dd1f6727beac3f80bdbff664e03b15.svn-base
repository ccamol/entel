...
<div class="estructuraTrafico">
	...
	<div class="clearfix">
		<h2 class="ico_grafico">
			<strong>Mi Tráfico Plan Vigente</strong> (Desde el  <h:outputText value="#{miTraficoController.detalleMiTraficoPlanVigente.fecha}">
...
<!-- TRAFICOS ANTERIORES -->
	...
	<div id="menu-desplegable" style="float: none;">
		...
		<div class="trafico-anterior-titulo">
            ...
            <a href="javascript:;" class="btn-trafico-anterior">Ver tráfico plan anterior (Desde  

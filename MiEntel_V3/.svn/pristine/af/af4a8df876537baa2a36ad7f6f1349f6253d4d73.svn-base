 ...
 * 
 */
public class ServiciosFactElecPropertiesHelper {

    /**
     * Logger para ServiciosBuzonPropertiesHelper
     */
    private static final Logger LOGGER = Logger
            .getLogger(ServiciosFactElecPropertiesHelper.class);

    private static final String PREFIX = "adminServicios.avisoFactElectronica.";

    /**
     * Singleton
     */
    private ServiciosFactElecPropertiesHelper() {
    }

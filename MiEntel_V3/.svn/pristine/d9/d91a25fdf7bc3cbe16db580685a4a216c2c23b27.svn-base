...
/**
 * Un proveedor de autenticacion para los servicios de autenticacion que expone el framework de seguridad de Weblogic.
 * Este le permite manipular el proveedor de seguridad (initialized, started, stopped, etc).
 * @author mmartinez (I2B) en nombre de Absalon Opazo (Atencion al Cliente,
 *         EntelPcs) 
 */
public final class EPCSApplicationAuthenticatorImpl implements
        AuthenticationProviderV2 {
    
    /**
     * Constante que encapsula el valor que identifica el control de acceso "SUFFICIENT".
     */
    private static final String SUFFICIENT = "SUFFICIENT";

    /**
     * Constante que encapsula el valor que identifica el control de acceso "REQUISITE".
     */
    private static final String REQUISITE = "REQUISITE";

    /**
     * Constante que encapsula el valor que identifica el control de acceso "OPTIONAL".
     */
    private static final String OPTIONAL = "OPTIONAL";

    /**
     * Constante que encapsula el valor que identifica el control de acceso "REQUIRED".
     */
     ...
     */
    private ApplicationLoginDAO loginDAO;
     ...
     */
    private static final Logger logger = Logger.getLogger(EPCSApplicationAuthenticatorImpl.class);
	...
	public void initialize(final ProviderMBean mbean,
		...
		logger.info("EPCSApplicationAuthenticatorImpl initialize...");
		loginDAO = new ApplicationLoginDAO();
		EPCSApplicationAuthenticationProviderMBean myMBean = (EPCSApplicationAuthenticationProviderMBean) mbean;
    ...
    /**
     * Permite obtener la configuracion para el LoginModule del provider de autenticacion de aplicaciones.
    ...
    public AppConfigurationEntry getLoginModuleConfiguration() {
        ...
        logger.info(EPCSApplicationLoginModuleImpl.class);
        return new AppConfigurationEntry(EPCSApplicationLoginModuleImpl.class
    ...
    public void shutdown() {
        logger.info("EPCSApplicationAuthenticatorImpl -> SecurityProvider#shutdown...");
    }
}

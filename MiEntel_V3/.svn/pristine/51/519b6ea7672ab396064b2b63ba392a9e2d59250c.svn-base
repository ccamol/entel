 ...
 * 
 */
public class ServiciosPPPropertiesHelper {

    /**
     * Logger para ServiciosHelper
     */
    private static final Logger LOGGER = Logger
            .getLogger(ServiciosPPPropertiesHelper.class);

    private static final String PREFIX = "adminServicios.pp.";

    /**
     * Singleton
     */
    private ServiciosPPPropertiesHelper() {
    }

...
/**
 * Clase utilitaria para obtener las propiedades de los diferentes servicios.<br>
 ...
 * 
 */
public class ServiciosPropertiesHelper {

    /**
     * Logger para ServiciosHelper
     */
    private static final Logger LOGGER = Logger
            .getLogger(ServiciosPropertiesHelper.class);

    private static final String PREFIX = "adminServicios.";

    // constructor privado para forza uso singleton
    private ServiciosPropertiesHelper() {
    }
    ...
    /**
     * Entrega el valor de la propiedad "idServicio" para el servicio indicado
    ...
    public static String getIdServicio(String servicio) {
        return getServicioProperty(servicio, "idServicio");
    }
    ...
    /**
     * Entrega el valor de la propiedad "activarTransferencia" para el servicio
     * indicado en <code>servicio</code>
     * 
     * @param servicio
     *            Servicio de quien se requiere la propiedad
     ...
     *         ser obtenida
     */
    public static String getActivarTransferencia(String servicio) {
        return getServicioProperty(servicio, "activarTransferencia");
    }
    ...
    /**
     * Entrega el valor de la propiedad "desactivarTransferencia" para el
     * servicio indicado en <code>servicio</code>
     * 
     * @param servicio
     *            Servicio de quien se requiere la propiedad
     * @return String con valor de la propiedad. <code>null</code> si no puede
     *         ser obtenida
     */
    public static String getDesactivarTransferencia(String servicio) {
        return getServicioProperty(servicio, "desactivarTransferencia");
    }

    /**
     * Entrega el valor de la propiedad "descripcionServicio" para el servicio
     * indicado en <code>servicio</code>
     * 
     * @param servicio
     *            Servicio de quien se requiere la propiedad
     ...
     *         ser obtenida
     */
    public static String getDescripcionServicio(String servicio) {
        return getServicioProperty(servicio, "descripcionServicio");
    }

...
<!--        </h:panelGroup>-->
	...
	<h:panelGroup rendered="#{historialBolsasController.existeHistoricoRecargas==null}">     
			<div class="mensaje-alerta-sistema-pequeno"> 
       			<div class="clearfix sub-contenedor"> 
           			...
           			<div class="texto">Servicio de consulta de hist&oacute;rico no disponible, intente más tarde.</div> 
       			</div> 
   			</div>
    </h:panelGroup>
    ...
    <p>Se presentan a continuación las bolsas compradas en los <strong>últimos 2 meses a contar del día 23 de mayo de 2013.</strong></p>
	<h1>
							...
							<h:panelGroup rendered="#{!traficoEnLineaController.errorDetalleTraficoEnLineaPPCC}">
								<div class="header_tabla trafico clearfix">
									...
									<div class="contenido_tabla">
											<h:panelGroup rendered="#{ !historialBolsasController.registros }">
											    <p>&nbsp;</p>
											 	<p align="center">No registras compra de bolsas en los últimos 2 meses.</p>
											</h:panelGroup>
